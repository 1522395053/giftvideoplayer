...
public class TextureCropUtil {
    ...
    public static float[] calculateCropCenter(float viewWidth, float viewHeight,
        ...
        topRatio = ratioY;
        bottomRatio = ratioY;
        return getCropData(leftRatio, topRatio, rightRatio, bottomRatio);
    }
...
//    }
    ...
    private static float[] getZoomData(float leftZoomRatio, float topZoomRatio, float rightZoomRatio, float bottomZoomRatio) {
        return new float[]{
                // x , y, s , t
                -1.0f + leftZoomRatio * 2, 1.0f - topZoomRatio * 2, 0.5f, 0.0f,
                1.0f - rightZoomRatio * 2, 1.0f - topZoomRatio * 2, 1.f, 0.0f,
                -1.0f + leftZoomRatio * 2, -1.0f + bottomZoomRatio * 2, 0.5f, 1.0f,
                1.0f - rightZoomRatio * 2, -1.0f + bottomZoomRatio * 2, 1.0f, 1.0f
        };
    }
    ...
    private static float[] getCropData(float leftCropRatio, float topCropRatio, float rightCropRatio, float bottomCropRatio) {
        return new float[]{
                // x , y, s , t
                -1.0f, 1.0f, 0.5f + leftCropRatio / 2, 0.f + bottomCropRatio,
                1.0f, 1.0f, 1.0f - rightCropRatio / 2, 0.f + bottomCropRatio,
                -1.0f, -1.0f, 0.5f + leftCropRatio / 2, 1.f - topCropRatio,
                1.0f, -1.0f, 1.0f - rightCropRatio / 2, 1.f - topCropRatio
        };
    }
}
